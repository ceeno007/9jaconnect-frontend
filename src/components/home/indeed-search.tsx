      ...
      <label className="flex h-12 items-center border-b border-r border-cloud px-3 sm:h-auto sm:min-h-[52px] sm:flex-1 sm:border-b-0 sm:border-r-0 sm:px-4">
        <div className="min-w-0 flex-1">
          ...
          <select
            ...
            className="w-full bg-transparent text-[15px] font-normal text-graphite outline-none sm:text-[15px]"
            aria-label="State"
          >
      ...
      >
        <div className="min-w-0 flex-1">
          ...
          <select
            ...
            disabled={!stateId}
            className="w-full bg-transparent text-[15px] font-normal text-graphite outline-none disabled:cursor-not-allowed sm:text-[15px]"
            aria-label="LGA"
          >
            <option value="">
              {selectedStateName
